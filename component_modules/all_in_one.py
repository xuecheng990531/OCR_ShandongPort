...
def match_jianyi_shuban(pos, value, save_path):
    ...
    shengchanchangjia = id2_vertical.match_shengchanchangjia(
        pos, value, save_path)
    ...
    baozhuangzhonglei = id2_vertical.match_baozhuangzhonglei(
        pos, value, save_path)
...
def match_weixian(pos, value, save_path):
    ...
    return {
        ...
        "闪点": shandian,
        "应急措施": yingjicuoshi,
        "包件种类": baojianzhonglei,
        "控制温度": kongzhiwendu,
        "海洋污染物": haiyangwuranwu,
        "总重": zongzhong,
        "净重": jingzhong
    }
...
def match_xingshizheng(pos, value, save_path):
    ...
    cheliangshibiedaihao = id5.match_cheliangshibiedaihao(
        pos, value, save_path)
    ...
    return {
        "车牌号码": chepaihaoma,
        "车辆类型": cheliangleixing,
        "所有人": suoyouren,
        "住址": zhuzhi,
        "使用性质": shiyongxingzhi,
        "品牌型号": pinpaixinghao,
        "车辆识别代号": cheliangshibiedaihao,
        "发动机号": fadongjihao,
        "注册日期": zhuceriqi,
        "核定载人数": zairenshu,
        "总质量": zongzhiliang,
        "整备质量": zhengbeizhiliang,
        "核定载质量": hedingzaizhiliang,
        "牵引总质量": qianyin_weight,
        "外廓尺寸": chicun,
        "有效期": youxiaoqi
    }
...
def match_tielu2(pos, value, save_path):
    ...
    quedingzhongliang_split = id7.quedingzhongliang_split(
        pos, value, save_path)
    ...
    return {
        ...
        '车种车号': chehao,
        '运单号': yundan,
        "托运名称": tuoyunmingcheng,
        "发站": fazhan,
        "托运联系人": tuoyunren,
        "托运联系人电话": tuoyun_phone,
        "收货名称": shouhuomingcheng,
        "到站": daozhan,
        "收货联系人": shouhuoren,
        "收货联系人电话": shouhuo_phone,
        '货物明细信息': d,
        '货物合计信息': hejixinxi,
        '费目信息': feimu_detail
    }
...
def match_haiyun(pos, value, Type, save_path):
    ...
    return {"提单号": tidanhao, "订舱号": dingcanghao}
...
def match_guobangdan(pos, value, save_path):
    ...
    return {
        ...
        "物料名称": wuliao,
        "车号": chehao,
        "进厂重量": jinchang_weight,
        "出厂重量": chuchang_weight,
        "净重": jing_weight
    }
